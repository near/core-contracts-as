...
Account.prototype.call = function (contractAccount, method, input, attachedDeposit) {
    ...
    console.log("------ " + 
        this.accountId + " CALL" + 
        (attachedDeposit? " with attachedDeposit:"+attachedDeposit: "") + " " +
    ...
    var context = {
        ...
        "attached_deposit": attachedDeposit||0, "is_view": false,
        "block_index": 1,
...
exp.Account = Account //export class Account
exp.spawn = spawn //export function spawn
exp.expect = expect
...
var spContract = new Account("staking-pool.alice").deploySmartContract(WASMFile)
...
//try deposit 100
bobDeposit = 100
depositResult = bob.callWithAttachedDeposit(bobDeposit, spContract, "deposit")
//console.log(util.inspect(bob.lastCallOutput))
